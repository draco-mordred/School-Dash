...
export const resolveClassLevelFromName = (className) => {
...
export const buildPhaseConfigForClassLevel = (classLevel) => {
    if (!classLevel)
        return {};
...
const AcademicClockSchema = new Schema({
    academicYear: {
...
const AcademicClock = mongoose.model("AcademicClock", AcademicClockSchema);
