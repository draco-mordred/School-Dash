...
export var studentLogbookEntryType_;
(function (studentLogbookEntryType_) {
    studentLogbookEntryType_["tutorialAndDemonstrations"] = "tutorialAndDemonstrations";
    studentLogbookEntryType_["clinicalActivities"] = "clinicalActivities";
    studentLogbookEntryType_["clinicalProcedures"] = "clinicalProcedures";
    studentLogbookEntryType_["clinicalPatientPresentations"] = "clinicalPatientPresentations";
...
export const StudentsLogbookEntryDetails = {
    tutorialAndDemonstrations: {
        ...
        mPointScored: (signed) => signed ? 1 : 0, // Example scoring logic
    },
    clinicalActivities: {
        id: mongoose.Types.ObjectId,
...
const StudentLogBookSchema = new Schema({
...
export default mongoose.model("StudentLogBook", StudentLogBookSchema);
