...
classRouter.get("/", protect, authorize(["admin", "teacher", "parent", "student", "unitconsultant", "unitresident"]), getAllClasses);
...
classRouter.delete("/:classId/courses/:courseId", protect, authorize(["admin", "teacher", "unitconsultant", "unitresident"]), removeCourseFromClass);
