...
import { createHospitalUnit, listHospitalUnits, getHospitalUnit, updateHospitalUnit, createHospitalStaff, listHospitalStaff, getHospitalStaff, updateHospitalStaff, bulkImportStaff, } from "../controllers/hospitalData";
const router = Router();
// ============ HOSPITAL UNITS ============
/**
