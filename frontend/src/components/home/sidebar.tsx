...
function Sidebar({
  ...
  const effectiveState = collapsed ? "collapsed" : state;
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:ml-[var(--sidebar-width-icon)] lg:ml-[var(--sidebar-width)] lg:peer-data-[state=collapsed]:ml-[var(--sidebar-width-icon)]",
...
function SidebarMenuSkeleton({
  ...
  // Use a fixed width for skeleton to avoid impure runtime calls and inline styles
