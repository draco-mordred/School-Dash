          ...
          <>
            ...
            >
              ...
              <CardContent className="space-y-3">
                ...
                <div className={`mt-2 grid gap-2 transition-all duration-300 ${isExpanded && showExpandedActions ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-2 opacity-0"}`}>
                  <Button
                    variant="outline"
                    className="w-full"
                    onClick={(e) => {
